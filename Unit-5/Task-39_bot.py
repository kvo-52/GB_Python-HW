...
# Реализовать игру игрока против игрока в терминале. Игроки ходят друг за
# другом, вписывая желаемое количество конфет. Первый ход определяется жеребьёвкой.
...
def sweets_game(rules, players, messages):
    count = rules[2]
...
winer = sweets_game(rules, players, messages)
if not winer:
